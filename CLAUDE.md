...
| Where | What |
|---|---|
| `decks/context.md` | Shared deck defaults — models, card design, cardtype tagging |
| `decks/languages/context.md` | Language deck defaults — cloze model, cloze syntax, level::* tagging |
